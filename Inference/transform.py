...
with open("data/mistral_multi/decompose_answer_v5_g2.json", "r") as file:
    g2_data = json.load(file)

with open("data/mistral_multi/decompose_answer_v5_g3.json", "r") as file:
    g3_data = json.load(file)

with open("/home/chenjunzhi/JARVIS/easytool/data_toolbench/result/gpt-4_easytool/G2_category.json", "r") as file:
    g2_gpt4_data = json.load(file)

with open("/home/chenjunzhi/JARVIS/easytool/data_toolbench/result/gpt-4_easytool/G3_instruction.json", "r") as file:
...
with open("data/mistral_multi/least_to_most_dfsdt_G2_v5_category.json", "w") as file:
    json.dump(g2_new_data, file, indent=4)

with open("data/mistral_multi/least_to_most_dfsdt_G3_v5_instruction.json", "w") as file:
